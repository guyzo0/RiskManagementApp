...
<div class="container-contact100">
		<div class="wrap-contact100">   
                        <form action = "{{ route('RisquePersonne.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur une personne</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "personne_id">Personne, Division, Departement, Direction</label>
                                            <select name="personne_id" id="personne" class="form-control">
                                                @foreach($personnes as $personne)
                                                    <option value="{{ $personne->id }}">{{$personne->id}}-{{$personne->nom_personne}}, {{$personne->division}}, 
                                                    {{$personne->departement}}, {{$personne->directtion}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($personnes as $personne)
                                                    <option value="{{ $personne->nom_personne }}">{{$personne->id}}-{{$personne->nom_personne}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
