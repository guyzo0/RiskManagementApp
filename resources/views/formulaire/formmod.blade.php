...
<div class="container-contact100">
		<div class="wrap-contact100">   
                        <form action = "{{ route('RisqueModule.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur un module</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "module_id">Module, Equipement, Division, Departement, Direction</label>
                                            <select name="module_id" id="module" class="form-control">
                                                @foreach($modules as $module)
                                                    <option value="{{ $module->id }}">{{$module->id}}-{{$module->nom_module}}, {{$module->equipement}}, 
                                                    {{$module->division}}, {{$module->departement}}, {{$module->direction}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($modules as $module)
                                                    <option value="{{ $module->nom_module }}">{{$module->id}}-{{$module->nom_module}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
