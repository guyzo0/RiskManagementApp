...
<div class="container-contact100">
		<div class="wrap-contact100">   
                        <form action = "{{ route('RisqueActivite.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur une activite</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "activite_id">Activite, Division, Departement, Direction</label>
                                            <select name="activite_id" id="activite" class="form-control">
                                                @foreach($activites as $activite)
                                                    <option value="{{ $activite->id }}">{{$activite->id}}-{{$activite->nom_activite}}, {{$activite->division}}, 
                                                    {{$activite->departement}}, {{$activite->direction}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($activites as $activite)
                                                    <option value="{{ $activite->nom_activite }}">{{$activite->id}}-{{$activite->nom_activite}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
