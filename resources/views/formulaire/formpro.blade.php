...
<div class="container-contact100">
		<div class="wrap-contact100">   
                        <form action = "{{ route('RisqueProcessus.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur un processus</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "processus_id">Processus, Division, Departement, Direction</label>
                                            <select name="processus_id" id="processus" class="form-control">
                                                @foreach($processuses as $processus)
                                                    <option value="{{ $processus->id }}">{{$processus->id}}-{{$processus->nom_processus}}, {{$processus->division}}, 
                                                    {{$processus->departement}}, {{$processus->Direction}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($processuses as $processus)
                                                    <option value="{{ $processus->nom_processus }}">{{$processus->id}}-{{$processus->nom_processus}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
