...
<div class="container-contact100">
		<div class="wrap-contact100">   
                        <form action = "{{ route('RisqueDivision.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur une division</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "division_id">Division, Departement, Direction</label>
                                            <select name="division_id" id="division" class="form-control">
                                                @foreach($divisions as $division)
                                                    <option value="{{ $division->id }}">{{$division->id}}-{{$division->nom_division}}, {{$division->departement}}, 
                                                    {{$division->direction}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($divisions as $division)
                                                    <option value="{{ $division->nom_division }}">{{$division->id}}-{{$division->nom_division}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
