...
<div class="container-contact100">
		<div class="wrap-contact100">    
                        <form action = "{{ route('RisqueEquipement.store')}}" method = "post">
                    @csrf
                    <span class="contact100-form-title">Formulaire d'analyse du Risque sur un equipement</span>
                    <fieldset>
                    <p class = "analyse">
                                <center><h3> Localisation</h3></center>
                                        <div class = "form-group">
                                            <label for = "equipement_id">Equipement, Division, Departement, Direction</label>
                                            <select name="equipement_id" id="equipement" class="form-control">
                                                @foreach($equipements as $equipement)
                                                    <option value="{{ $equipement->id }}">{{$equipement->id}}-{{$equipement->nom_equipement}}, {{$equipement->division}}, 
                                                    {{$equipement->departement}}, {{$equipement->direction}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                </p>
                                    <p>
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select name="titre" id="titre" class="form-control">
                                                @foreach($equipements as $equipement)
                                                    <option value="{{ $equipement->nom_equipement }}">{{$equipement->id}}-{{$equipement->nom_equipement}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class = "form-group">
