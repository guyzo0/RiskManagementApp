                    ...
                    @csrf
                        <fieldset>
                                        ...
                                        <div class = "form-group">
                                            <label for = "label_gravite">Label gravite</label>
                                                @if($risqueModule->niveau_gravite==1 || $risqueModule->niveau_gravite==2)
                                                    <div class="p-3 mb-2 bg-success text-white">{{ $risqueModule->label_gravite}}</div>                                                
                                                @elseif($risqueModule->niveau_gravite==3)
                                                    <div class="p-3 mb-2 bg-warning text-white" role="alert">{{ $risqueModule->label_gravite}}</div>
                                                @else
                                                    <div class="p-3 mb-2 bg-danger text-white">{{ $risqueModule->label_gravite}}</div>
                                                @endif                                        
                                        </div>
                                    </div>
                                </p>
                                <p class = "preconisations">
                                    ...
                                    <div class="form-group">
                                    <center>
                                        <a href="{{ route('listRisque_module')}}" class="btn btn-success btn-lg">Retour</a>
                                    </center>
                        </div>
                        </form>
                    </div>
