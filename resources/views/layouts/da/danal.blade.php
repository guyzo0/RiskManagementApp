  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a href="#" class="d-block">{{ Auth::guard('web')->user()->name }}: ANALYST</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{route('globalform_direction')}}" class="nav-link link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Direction form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_departement')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Departement form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_division')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Division form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_equipement')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Equipement form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_module')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Module form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_carte')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Carte form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_port')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Port form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_activite')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Activite form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_personne')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Personne form</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('globalform_processus')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Processus form</p>
                </a>
              </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Analyst Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
