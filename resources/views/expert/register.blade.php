...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Register as Expert') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('expert.register') }}">
                        ...
                        <div class="form-group row">
                            <label for="pseudo" class="col-md-4 col-form-label text-md-right">{{ __('Pseudo Code') }}</label>
