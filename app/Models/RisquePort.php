...
class RisquePort extends Model
{
    ...
    public function getGraviteIntrinsequeGeneral()
    {
         $p = 0;
         $t = $this->latest('id');
         $j = $this->gravite_intrinseque;

         for($this->id=1; $this->id<=$t; $this->id++)
         {
              $p = $p + $j;
         }
              return $p/$t;
    ...
    public function getGraviteGeneral()
    {
         $p = 0;
         $t = $this->latest('id');
         $j = $this->niveau_gravite;
    ...
    public function getNiveau_graviteG()
    {
         $n=0;
         $d = $this->id;
         $ld = last($d);
         ...
         {
              $t = $this->titre;
               if ($this->validation==1 && $this->titre==$t)
               {
                    $n = $n+0;
               }
               else
               {
                    $n = $n + $this->niveau_gravite;
               }
         }
         return $n;
    }
