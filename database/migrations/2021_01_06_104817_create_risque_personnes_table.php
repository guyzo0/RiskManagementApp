...
class CreateRisquePersonnesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('risque_personnes', function (Blueprint $table) {
            $table->increments('id');
            $table->string('titre');
            ...
            $table->timestamps();
            $table->bigInteger('personne_id')->unsigned()->index();
    ...
    {
        Schema::dropIfExists('risque_personnes');
    }
}
