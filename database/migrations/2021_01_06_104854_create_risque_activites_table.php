...
class CreateRisqueActivitesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('risque_activites', function (Blueprint $table) {
            $table->increments('id');
            $table->string('titre');
            ...
            $table->timestamps();
            $table->bigInteger('activite_id')->unsigned()->index();
    ...
    {
        Schema::dropIfExists('risque_activites');
    }
}
