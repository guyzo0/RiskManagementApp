...
class CreateRisqueDepartementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('risqueDepartements', function (Blueprint $table) {
            ...
            $table->integer('niveau_gravite')->null;
    ...
    {
        Schema::dropIfExists('risqueDepartements');
    }
}
